...
const char* default_TOPICO_PUBLISH_1 = "/TEF/device015/attrs"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_2 = "/TEF/device015/attrs/p"; // Tópico MQTT de envio de informações para Broker
